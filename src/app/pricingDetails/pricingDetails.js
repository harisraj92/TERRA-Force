...
const Pricing = () => {
    ...
    return (
        <div>
            <section className="py-6 bg-gray-100 text-gray-900 rounded-3xl">
                <div className="container mx-auto p-4 sm:p-10">
                    ...
                    {/* Pricing Cards */}
                    <div className="grid max-w-md grid-cols-1 gap-6 mx-auto lg:max-w-full lg:grid-cols-3">
                        {/* Starter Plan */}
                        <div className="relative flex flex-col items-center p-8 border rounded-md bg-white shadow">
                            <span className="absolute top-0 px-6 pt-1 pb-2 font-medium rounded-b-lg bg-yellow-700 text-gray-50">
                                Starter
                            </span>
                            ...
                            <ul className="flex-1 space-y-2">
                                ...
                                <li className="flex items-center space-x-2">
                                    ...
                                    <span>On-Site Property Inspections</span>
                                </li>
                                <li className="flex items-center space-x-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6 dark:text-violet-600">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
                                    </svg>
                                    <span>Multimedia Property Updates</span>
                                </li>
                        ...
                        {/* Standard Plan */}
                        <div className="relative flex flex-col items-center p-8 border-2 rounded-md bg-white shadow">
                            <span className="absolute top-0 px-6 pt-1 pb-2 font-medium rounded-b-lg bg-yellow-700 text-gray-50">
                                Standard
                            </span>
                            <p className="flex items-center justify-center my-6 space-x-2 font-bold">
                            ...
                            <ul className="flex-1 space-y-2">
                                ...
                                <li className="flex items-center space-x-2">
                                    ...
                                    <span>Building & Flat Services</span>
                                </li>
                            </ul>
                        ...
                        <div className="relative flex flex-col items-center p-8 border rounded-md bg-white shadow">
                            ...
                            <ul className="flex-1 space-y-2">
                                ...
                                <li className="flex items-center space-x-2">
                                    ...
                                    <span>Vacant Land Services</span>
                                </li>
                                <li className="flex items-center space-x-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6 dark:text-violet-600">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
